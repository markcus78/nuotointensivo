...
const phases = [
  {
    ...
    duration: "60 secondi",
    name: "PRENOTA",
    body: "Compili il modulo qui sotto. Nome, cognome, telefono, fascia d'età, formato che preferisci. Nessun pagamento ora.",
    detail: "→ Solo lead, niente carta di credito.",
    warn: false,
  },
  {
    n: "02",
    duration: "Entro 24h",
    name: "TI CHIAMIAMO",
    body: "Un istruttore ti contatta per confermare il livello di nuoto, l'orario migliore e il formato. Ti spieghiamo tutto e fissiamo l'iscrizione.",
    detail: "→ Pagamento al momento dell'iscrizione, in struttura.",
    warn: false,
  },
  {
    n: "03",
    ...
    detail: "→ Per i bambini: certificato medico se non già fornito.",
    warn: true,
  },
  {
    n: "04",
